"""
Django settings for checkuser_3 project.
...
WSGI_APPLICATION = 'checkuser_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "checkuser_3 API",
    "DESCRIPTION": "API documentation for checkuser_3 App",
    "VERSION": "v1",
}
